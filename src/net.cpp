...
// Copyright (c) 2015-2016 Gbcoin Developers
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Gbcoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strMainNetDNSSeed[][2] = {
    {"helloc.biz", "121.78.237.201"},

    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"ssaomi.com", "tseed.ssaomi.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Gbcoin is probably already running."), addrBind.ToString().c_str());
        else
